...
// 执行增强时的滑动条数据
int clipL = 10, gridXL = 8, gridYL = 8;
int clipR = 10, gridXR = 8, gridYR = 8;
// 临时保存的增强图像
...
int main() {
    ...
    // 加载标定所用图像文件的路径
    ifstream finL("data/20170810_calib1-2_L.txt");
    ifstream finR("data/20170810_calib1-2_R.txt");
    // 加载测距所用的图像文件路径
    ifstream finRangingL("data/20170810_ranging1_L.txt");
    ifstream finRangingR("data/20170810_ranging1_R.txt");
    // 保存标定结果的文件
    ofstream foutL("data/20170810_calib_result1_L.txt");
    ofstream foutR("data/20170810_calib_result1_R.txt");
    ofstream foutStereo("data/20170810_stereo_result1.txt");
